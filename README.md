...
For specific users, copy `continue_folder.py` to the appropriate path below...
|Platform|Path|
|---|---|
...
For specific users, copy `continue_folder.py` to `/opt/Autodesk/user/<user name>/python/`
